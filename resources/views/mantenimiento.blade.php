    ...
    <div class="menu">
        ...
        <ul class="lis">
            ...
            <li  class="servicios">
                ...
                <ul class="sub_links">
                <li> <a id="pag" href="mantenimiento">Mantenimiento</a></li>
...
<div class="imagenprincipal"> 
   ...
   <div class="sub1">
    <label class="descubre"  data-aos="zoom-in-down" data-aos-duration="1000" >{!!setting('site.i1')!!}</label> <hr class="linea"><br>
    <label class="titu1" data-aos="zoom-in-right" data-aos-duration="1000">{!!setting('site.i2')!!}</label><br>
    <label class="titu2"  data-aos="zoom-in-down" data-aos-duration="1000">{!!setting('site.i3')!!}</label><br>
    <p class="parrafo" data-aos="zoom-in-left" data-aos-duration="1000">{!!setting('site.i4')!!}</a></p>
  </div>
